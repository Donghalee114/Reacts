    ...
    <>
      ...
      <div style={{ paddingTop: "60px" }}>
        ...
        <div id="projects" data-aos="fade-right" style={{
          ...
          <h1 style={{ fontSize: "2.5rem", marginBottom: "40px" }}>📁 Projects and Practice</h1>
          <div style={{
            display: "flex",
            justifyContent: "center",
            gap: "100px",
            ...
            <ProjectCard
            title="FrontEnd Pratice_1"
            desc ="Frontend Mentor - Intro section with dropdown navigation 사이트에서 제공한 무료 챌린지 디자인입니다."
            link="/SitePractice_1"/>
          </div>
        </div>
