 ...
 const handleOpenFeature = () => {
  ...
  return(
    ...
    <div style={{cursor : "pointer"}} onClick={handleOpenFeature}>
      <div>Features <img src={isFeatureOpen ? arrowUp : arrowDown}/></div>
     ...
     <div style={{cursor : "pointer"}} onClick={handleOpenCompany}>
      <div>Company <img src={isCompanyOpen ? arrowUp : arrowDown}/></div>
    ...
    <div style={{ display : "flex" , gap : "30px", fontSize:"15px" , cursor : "pointer"  , alignItems : "center"}}>
...
<div style={{ marginTop : "150px" , display:"flex" , alignItems : "center" , justifyContent : "start" ,gap : "50px" }}>
      ...
      <img  style={{width :"650px", marginTop : "150px", marginRight :"500px"}} src = {mainImg}/>
</div>
